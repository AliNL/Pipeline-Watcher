...
class ErrorsTicketsWindow(object):
    ...
    def set_person_today(self):
        ...
        self.app.setLabelBg(self.dev_today, "#535353")
        self.app.setLabelFg(self.dev_today, "white")
        self.app.setLabelBg(self.bqa_today, "#535353")
        self.app.setLabelFg(self.bqa_today, "white")
    ...
    def start(self):
        ...
        for i in range(len(self.bqa_list)):
            self.app.addLabel(self.bqa_list[i], self.bqa_list[i], 1, i, 1, 1)
