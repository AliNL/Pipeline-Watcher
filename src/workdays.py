...
def networkdays(start_date, end_date, holidays=None, weekends=None, extraworkdays=[]):
    if weekends is None:
        weekends = [SAT, SUN]
    if holidays is None:
        holidays = []
...
def workday(start_date, days=0, holidays=None, weekends=None):
    if weekends is None:
        weekends = [SAT, SUN]
    if holidays is None:
        holidays = []
